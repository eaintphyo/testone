...
public class TownshipAdapter extends BaseAdapter {
    ...
    private List<Township> townships = null;

    public TownshipAdapter(Context context) {
        inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }

    public void setData(List<Township> details) {
        this.townships = details;
    }
    ...
    public Object getItem(int position) {
        if (townships == null || townships.get(position) == null) {
            return null;
        }
        return townships.get(position);
    }
    ...
    public View getView(int position, View currentView, ViewGroup parent) {
        ...
        Township township = townships.get(position);

        if (township != null) {
            ((TextView) currentView.findViewById(R.id.name)).setText(township.getName());
            ((TextView) currentView.findViewById(R.id.votes)).setText(String.valueOf(township.getId()));
        }
